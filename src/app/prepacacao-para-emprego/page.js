      ...
      <div className={styles.containerDisease}>
        <div>
          ...
          >
            ...
            Identificar a sua área de trabalho e sua ligação com outras áreas da
            organização
          </button>
          ...
          >
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>Unidade de internamento</span>{' '}
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>Banco de Emergência</span> Onde
              pacientes em situações de emergência recebem atendimento médico
              imediato.
            </p>
            <p className={styles.paragraph}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>Consultas externas</span> Onde
              pacientes com condições menos críticas recebem atendimento médico,
              o que inclui anamnese, prescrição de medicamentos, entre outros.
            </p>
            <p className={styles.paragraph}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}></span>As atividades podem ser
              divididas em:{' '}
            </p>
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>-Inserção de sondas</span>{' '}
            </p>
            <p className={styles.paragraph}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>-Promoção de saúde</span>{' '}
            </p>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>-Planejar cuidados</span>{' '}
            </p>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>-Avaliar resultados</span>{' '}
            </p>
        ...
        <div>
          ...
          >
            <p className={styles.paragraph}>
              ...
              A gestão do tempo é uma essencial tarefa para um TMG, pois permite garantir um atendimento de qualidade, evita erros clínicos, reduz o stress e aumenta a eficiência nos serviços de saúde.
            </p>

            <h3 className={styles.subtitle}>No contexto hospitalar ou unudade sanitária o tempo deve ser bem  distribuido entre: </h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Identificação de tarefas e Identificação de prioridades</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                
              </span>{' '}
              O TMG deve ser capaz de Identificar todas as tarefas como por exemplo:
            </p>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                Realizar anamnese
            ...
            <h3 className={styles.subtitle}>Clasificação das tarefas quanto a prioridade</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                
              </span>{' '}
              As tarefas podem ser clasificadas em:
            </p>
            ...
            <h3 className={styles.subtitle}>Importantes mas não Urgentes</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                Planejamento de cuidados
              </span>{' '}
            ...
            <p className={styles.paragraph}>
              ...
              Um paciente com falta de ar deve ser atendido primeiro.
            </p>

            <h3 className={styles.subtitle}>Gestão do tempo para a execução de tarefas</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Estimar o tempo para cada atividade:</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Identificar o melhor momento do dia:</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                Manhã:  
              </span>{' '}
            ...
            <p className={styles.paragraph}>
              ...
              Monitorização e emergências
            </p>

            <h3 className={styles.subtitle}>Organizar o trabalho do dia:</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Priorização e organização de agendas</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Rezervar tempo para emprevistos:</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                Emergências médicas
              </span>{' '}
            ...
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                Ajustar o plano quando necessário, por exemplo: se surgir uma urgência o técnico deve reorganizar rapdamente a agenda
              </span>{' '}

            </p>

            <h3 className={styles.subtitle}>Pontualidade e cumprimento de prazos</h3>
            <h3 className={styles.subtitle}>Importância da Pontualidade:</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Registo e organização da informação</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Atualizar informações importantes:</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
                Dados do paciente
              </span>{' '}
            ...
            <h3 className={styles.subtitle}>Importância do registo e organização da informação</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <h3 className={styles.subtitle}>Aplicação prática no serviço de saúde</h3>
            <p className={styles.paragraph}>
              <span className={styles.highlight}>
            ...
            <p className={styles.paragraph}>
              ...
              Tudo isso exige boa gestão do tempo e organização.
            </p>
          </div>
        </div>
      </div>
