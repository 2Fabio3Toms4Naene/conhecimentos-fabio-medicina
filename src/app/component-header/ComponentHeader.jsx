...
export default function ComponentHeader() {
  ...
  return (
    <header
      className={`${styles.header} ${theme ? stylesPage.dark : stylesPage.light}`}
    >
      <div className={styles.containerLogo}>
        <Image
          ...
          width={50}
          height={50}
          className={`${styles.logoHeader} ${theme ? styles.iconInvert : ''}`}
        />
      ...
      <div className={styles.containerSearch}>
        <FaSearch
          className={`${styles.iconSearch} ${theme ? styles.iconInvert : ''}`}
        />
        <input
          type="text"
      ...
      <div className={styles.containerTheme}>
        <button onClick={toggleTheme} className={styles.buttonTheme}>
          {theme ? (
            <GoSun className={`${styles.iconTheme} ${styles.iconInvert}`} />
          ) : (
            <FaRegMoon className={styles.iconTheme} />
          )}
        </button>
      </div>
    </header>
